...
app_identifier "com.eminisrafil.xcode7beta3CITest2" # The bundle identifier of your app
apple_id "1018099468" # This is NOT your Apple login ID, but the App ID of your app
email "eminisrafil@gmail.com" # the login email address